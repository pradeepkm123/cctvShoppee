...
//   const [searchTouched, setSearchTouched] = useState(false); // to control "no data" message
...
//     // match against the requested fields; adjust keys to your schema
//     const fields = [
//       p?.name,
//       p?.brand,
//       p?.category,
...
//       // Option A: fetch all then filter (current)
...
//       // Option B (future): if you add a backend search endpoint, use this:
//       // const { data } = await axios.get(`${API_BASE}/products`, { params: { search: term }});
...
//     return () => document.removeEventListener('mousedown', closeSearchIfClickedOutside);
//   }, []);
...
//                           >
//                             {searchLoading ? (
//                               <div style={{ padding: '12px 16px' }}>Searching…</div>
...
//                                 {/* “no data means show that message” */}
...
//                                 >
//                                   <div style={{ flex: 1 }}>
//                                     <div style={{ fontWeight: 600 }}>{p?.name || 'Unnamed Product'}</div>
//                                     <div style={{ fontSize: 12, color: '#666' }}>
//                                       {p?.brand ? `${p.brand} • ` : ''}
//                                       {p?.category || p?.productType || ''}
//                                     </div>
//                                   </div>
//                                   <div style={{ marginLeft: 12, whiteSpace: 'nowrap', fontWeight: 600 }}>
//                                     {typeof p?.newPrice === 'number' ? `₹${p.newPrice}` : ''}
//                                   </div>
//                                 </button>
//                               ))
//                             )}
