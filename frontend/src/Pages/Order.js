...
//   // ---- Fetch categories once and map by _id ----
//   useEffect(() => {
...
//   // ---- Filters update from child (checkboxes) ----
...
//     return safe.startsWith('http') ? safe : `http://localhost:5000/uploads/${safe.split('/').pop()}`;
//   };
...
//                           <div className="status-badge status-arriving">
