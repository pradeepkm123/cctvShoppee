                  ...
                  <div className="row">
                     <div className="col-xl-8 col-lg-10">
                        <div className="tp-about-banner-wrapper">
                           <span className="tp-about-banner-subtitle">History</span>
                           <h3 className="tp-about-banner-title">Well-coordinated Teamwork Speaks About Us</h3>
                        </div>
                     </div>
                  </div>
                  <div className="row">
                     <div className="col-xl-12">
                        <div className="tp-about-banner-thumb w-img">
                           <img src="assets/img/about/about-big-1.jpg" alt="About Us" />
                        </div>
                     </div>
                  </div>
                  <div className="row">
                        ...
                        <div className="tp-counter-wrapper d-flex flex-wrap justify-content-between">
                           <div className="tp-counter-item d-flex align-items-start mb-30">
                              ...
                              <div className="tp-counter-content">
                                 <h4><span className="purecounter" data-purecounter-duration="1" data-purecounter-end="750">0</span>+</h4>
                                 <p>Happy Customers</p>
                              </div>
                           </div>
                           <div className="tp-counter-item d-flex align-items-start mb-30">
                              ...
                              <div className="tp-counter-content">
                                 <h4><span className="purecounter" data-purecounter-duration="1" data-purecounter-end="2016">0</span></h4>
                                 <p>Founding Year</p>
                              </div>
                           </div>
                           <div className="tp-counter-item d-flex align-items-start mb-30">
                              ...
                              <div className="tp-counter-content">
                                 <h4><span className="purecounter" data-purecounter-duration="1" data-purecounter-end="120">0</span>+</h4>
                                 <p>Product Orders</p>
                              </div>
                           </div>
                           <div className="tp-counter-item d-flex align-items-start mb-30">
                              ...
                              <div className="tp-counter-content">
                                 <h4><span className="purecounter" data-purecounter-duration="1" data-purecounter-end="60">0</span>+</h4>
