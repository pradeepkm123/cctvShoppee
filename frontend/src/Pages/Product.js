...
//                             <p>Showing {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, filteredProducts.length)} of {filteredProducts.length} results</p>
//                           </div>
//                         </div>
//                       </div>
//                       <div className="col-xl-6">
...
//                               <span className="current">Price Sort</span>
//                               <ul className="list">
//                                 <li data-value="Default Sorting" className="option selected">Default Sorting</li>
//                                 <li data-value="Low to High" className="option">Low to High</li>
//                                 <li data-value="High to Low" className="option">High to Low</li>
//                                 <li data-value="New Added" className="option">New Added</li>
//                                 <li data-value="On Sale" className="option">On Sale</li>
//                               </ul>
//                             </div>
//                           </div>
//                           <div className="tp-shop-top-filter">
//                             <button type="button" className="tp-filter-btn filter-open-btn">
//                               <span>
