...
function Checkout() {
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      try {
        ...
        const response = await fetch('https://api.cctvshoppee.com/api/supercoins/balance', {
          headers: {
  ...
  const verifyUpiId = async (upiId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://api.cctvshoppee.com/api/checkout/verify-upi', {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (useSuperCoins) {
        ...
        const useSuperCoinsRes = await fetch('https://api.cctvshoppee.com/api/supercoins/use', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
      ...
      const paymentRes = await fetch('https://api.cctvshoppee.com/api/payments/payment-link', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
      ...
      const orderRes = await fetch('https://api.cctvshoppee.com/api/orders', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
      ...
      if (orderRes.ok) {
        ...
        try {
          await fetch('https://api.cctvshoppee.com/api/supercoins/earn', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${token}`,
        ...
        // Step 5: Clear Cart
        try {
          await fetch('https://api.cctvshoppee.com/api/cart/clear', {
            method: 'DELETE',
            headers: {
              Authorization: `Bearer ${token}`,
            },
