...
//         const response = await fetch(`http://localhost:5000/api/orders/${order._id}/timeline`, {
//           method: "GET",
//           headers: {
...
//     try {
//       const token = localStorage.getItem("token");
//       const response = await fetch(`http://localhost:5000/api/orders/${order._id}/refund`, {
//         method: "PUT",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${token}`,
...
//                     <img
//                       src={`http://localhost:5000/uploads/${order.items[0]?.productId?.image}`}
...
//           {["details", "timeline", "shipment", "customer"].map((tab) => (
//             <button
//               key={tab}
//               style={{
//                 padding: "12px 16px",
