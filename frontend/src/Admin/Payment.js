...
//   const totalRevenue = 342891;
//   const successfulPayments = 1234;
//   const pendingPayments = 45;
//   const failedPayments = 23;
...
//                   <th style={{ padding: '12px 20px', textAlign: 'left', fontSize: '11px', fontWeight: '600', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
//                     PAYMENT ID
//                   </th>
//                   <th style={{ padding: '12px 20px', textAlign: 'left', fontSize: '11px', fontWeight: '600', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
//                     ORDER ID
...
//               Showing {startIndex + 1} of {filteredPayments.length} payments
//             </div>
//             <div style={{ display: 'flex', gap: '8px' }}>
//               <button
