...
//       toast.error('Select one product to delete.');
//       return;
//     }
...
//               <h1 className="fs-4 mb-0">Product</h1>
//             </div>
//           </div>
//         </div>
...
//               <button className="btn btn-export btn-sm">
//                 <i className="las la-upload"></i> Export
//               </button>
//               <button className="btn btn-import btn-sm">
//                 <i className="las la-download"></i> Import
//               </button>
//             </div>
//           </div>
//           <div className="col-md-6">
//             <div className="action-buttons">
//               <button className="btn btn-add btn-sm" onClick={handleAddProduct}>
//                 <i className="las la-plus"></i> Add Product
//               </button>

//               {productToEdit ? (
//                 <EditProductDrawer open={drawerOpen} onClose={handleCloseDrawer} productToEdit={productToEdit} />
//               ) : (
//                 <AddProductDrawer open={drawerOpen} onClose={handleCloseDrawer} categories={categories} />
//               )}
//             </div>
//           </div>
//         </div>
...
//             <div className="d-flex gap-2">
//               <button className="btn btn-delete flex-grow-1" onClick={handleDeleteSelectedProducts}>
//                 <i className="las la-trash"></i> Delete
//               </button>
//               <button className="btn btn-reset flex-grow-1" onClick={handleReset}>
...
//             <div className="parents-only-switch">
//               <span className="parents-only-label">Parents Only</span>
//               <div className="form-check form-switch">
//                 <input className="form-check-input" type="checkbox" id="parentOnlySwitch" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//                             <a href="#" className="action-icon" onClick={(e) => { e.preventDefault(); handleEditProduct(p); }}>
//                               <i className="las la-pen"></i>
//                             </a>
//                             <a href="#" className="action-icon" onClick={(e) => { e.preventDefault(); handleDeleteProduct(p._id); }}>
