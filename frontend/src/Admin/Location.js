...
//     { id: 1, name: 'Chennai', warehouse: 'HEAD OFFICE', createdOn: '2025-07-22', status: 'Active', checked: false },
//     { id: 2, name: 'Avadi', warehouse: 'N/A', createdOn: '2025-07-24', status: 'Active', checked: false },
//     { id: 3, name: 'PORUR', warehouse: 'porur', createdOn: '2025-08-20', status: 'Active', checked: false },
//     { id: 4, name: 'JAIPUR', warehouse: 'JAIPUR', createdOn: '2025-08-20', status: 'Active', checked: false }
//   ]);
...
//                   value={formatDateDisplay(formData.createdOn)}
//                   readOnly
//                 />
//                 <input
//                   type="date"
...
//                 <span style={{ marginLeft: '12px', fontWeight: '500' }}>Status</span>
//               </label>
//             </div>
...
const LocationManagement = () => {
  ...
  const handleSaveLocation = async () => {
    try {
      ...
      if (editingLocation) {
        ...
        await axios.put(`http://localhost:5000/api/locations/${editingLocation._id}`, locationData);
      } else {
        // Add new location
  ...
  const handleConfirmDelete = async () => {
    try {
      await axios.delete(`http://localhost:5000/api/locations/${selectedLocation._id}`);
      // Refresh the locations list
      await fetchLocations();
      setShowDeleteModal(false);
      setSelectedLocation(null);
