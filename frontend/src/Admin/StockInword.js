...
// //     { id: 1, modelNo: '', quantity: 0, currentStock: 0, scannedCodes: [], scanBarcode: '' }
// //   ]);
// //   const [selectedLocation, setSelectedLocation] = useState('');

// //   const locations = ['Chennai', 'Jaipur', 'Porur', 'Avadi'];
...
// //     setModels([
// //       ...models,
// //       { id: models.length + 1, modelNo: '', quantity: 0, currentStock: 0, scannedCodes: [], scanBarcode: '' }
// //     ]);
// //   };
...
// //     if (model.scanBarcode.trim()) {
// //       setModels(models.map(m =>
// //         m.id === id
// //           ? {
// //               ...m,
// //               scannedCodes: [...m.scannedCodes, model.scanBarcode],
// //               scanBarcode: ''
// //             }
// //           : m
// //       ));
...
// //     return models.reduce((total, model) => total + model.scannedCodes.length, 0);
// //   };
...
// //             <RotateCw size={48} color="#4285f4" className="scan-icon" />
// //           </div>
...
// //           >
// //             <RotateCw size={20} style={{ marginRight: '8px' }} />
// //             Start Scanning
// //           </button>
// //         </div>
// //       </div>
...
// //       {/* Scan Modal */}
// //       {showScanModal && (
// //         <div style={styles.modalOverlay} className="modal-overlay" onClick={() => setShowScanModal(false)}>
// //           <div style={styles.scanModalContent} className="modal-content" onClick={(e) => e.stopPropagation()}>
// //             <div style={styles.scanIconContainer}>
// //               <RotateCw size={48} color="#4285f4" className="scan-icon" />
// //             </div>
// //             <h2 style={styles.scanTitle}>Scan Product Barcode</h2>
...
// //               <h2 style={styles.modalTitle}>Stock Inward</h2>
// //               <button
...
// //                 <div key={model.id} style={styles.modelSection}>
// //                   <div style={styles.modelHeader}>
// //                     <h3 style={styles.modelTitle}>Model #{index + 1}</h3>
// //                     <button
...
// //                     <div style={styles.modelField}>
// //                       <label style={styles.label}>Model No *</label>
// //                       <select
// //                         style={styles.selectField}
// //                         className="select-field"
// //                         value={model.modelNo}
// //                         onChange={(e) => handleModelChange(model.id, 'modelNo', e.target.value)}
// //                       >
...
// //                         ))}
// //                       </select>
// //                       <div style={styles.stockInfo}>Current stock: {model.currentStock}</div>
// //                     </div>
...
// //                         onChange={(e) => handleModelChange(model.id, 'quantity', e.target.value)}
// //                       />
// //                       <div style={styles.quantityInfo}>
// //                         <span>Typed value caps how many barcodes you can scan for this row</span>
// //                         <span>After inward: {model.currentStock + parseInt(model.quantity || 0)}</span>
// //                       </div>
// //                       <div style={styles.scanLimit}>No scan limit (uses scanned count)</div>
// //                     </div>
// //                   </div>
...
// //                       value={model.scanBarcode}
// //                       onChange={(e) => handleModelChange(model.id, 'scanBarcode', e.target.value)}
// //                       onKeyPress={(e) => {
// //                         if (e.key === 'Enter') {
// //                           handleScanBarcode(model.id);
// //                         }
// //                       }}
// //                     />
// //                     <div style={styles.barcodeHint}>
...
// //                       readOnly
// //                       value={model.scannedCodes.join('\n')}
// //                     />
// //                     <div style={styles.totalScanned}>Total scanned: {model.scannedCodes.length}</div>
// //                   </div>
// //                 </div>
// //               ))}
...
// //                 <div style={styles.previewEmpty}>No products selected yet</div>
// //               </div>
// //             </div>
...
// import { RotateCw, Plus, Trash2, X, Save, Calendar, User, FileText } from 'lucide-react';
...
//       const response = await fetch('http://localhost:5000/api/stock-inward', {
//         method: 'POST',
//         headers: {
...
//         alert('Stock inward added successfully!');
...
//       alert('Failed to submit stock inward');
//     } finally {
//       setLoading(false);
//     }
//   };
...
//                                 {product.name} - {product.modelNo} (Stock: {product.currentStock})
//                               </option>
//                             ))}
//                           </select>
//                         </div>
...
//                           <div>After Inward: {product.currentStock + parseInt(item.quantity || 0)}</div>
//                         </div>
//                       )}
//                     </div>
//                   );
